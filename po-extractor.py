...
from po_formats import text_extract, po_base, po_type_1, po_type_2, po_type_3, po_type_4, po_type_5, po_type_6, po_type_7, po_type_8, po_type_9
...
class PO_Extractor:
    ...
    def __getPurchaseOrderFileType(self,poDocFilepath:str)->list:
        ...
        if "PRIMARK" in poDoc.getPage(1).upper():
            ...
            return ["TYPE-8",None]
        elif "WM MORRISON" in poDoc.getPage(1).upper():
            return ["TYPE-9",None]
    ...
    def __extractData(self,poDocFilepath:str)->tuple:
        ...
        match poFileType:
            ...
            case "TYPE-9":
                poDoc = po_type_9.PO_TYPE_9(poDocFilepath)
        ...
        for poDetail in poDetails:
            ...
            for destNumber in purchaseOrders.keys():
                ...
                for packData in packsData:
                    ...
                    if poFileType not in ["TYPE-1", "TYPE-8", "TYPE-9" ]:
